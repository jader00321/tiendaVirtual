    ...
    <div class="card shadow-lg" style="width: 100%; max-width: 500px;">
        <div class="card-body p-5">
            ...
            <div class="text-center mt-4">
                <p class="mb-0">¿Ya tienes una cuenta? <a href="${pageContext.request.contextPath}/login.jsp">Inicia sesión</a></p>
            </div>
        </div>
    </div>
</div>
...
<script>
    function validarPassword() {
        ...
        errorDiv.classList.add('d-none'); // Oculta el mensaje si son iguales
