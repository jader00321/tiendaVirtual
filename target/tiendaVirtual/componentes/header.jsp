...
<head>
    ...
    <link rel="icon" href="${pageContext.request.contextPath}/imagenes/favicon.png" type="image/png">
            ...
            <nav class="header__nav">
                <ul>
                    ...
                    <c:if test="${sessionScope.usuario.rol == 'ADMIN'}">
                        <li><a href="${pageContext.request.contextPath}/gestion">Gestion General</a></li> 
                        <li><a href="${pageContext.request.contextPath}/admin/usuarios">Gestionar Usuarios</a></li> 
                    </c:if>
