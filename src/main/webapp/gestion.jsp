...
<div class="container mt-4">
        ...
        <div class="tarjeta-contenido__cuerpo card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    <thead><tr><th>#</th><th>ID</th><th>Nombre</th><th>Imagen</th><th class="text-end">Acciones</th></tr></thead>
                    <tbody>
                        <c:forEach var="cat" items="${listaCategorias}" varStatus="loop">
                            <tr>
                                <td>${loop.count}</td><td>${cat.id}</td><td><c:out value="${cat.nombre}"/></td>
    ...
    <div class="tarjeta-contenido card mb-4">
        ...
        <div class="tarjeta-contenido__cuerpo card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    <thead><tr><th>#</th><th>ID</th><th>Nombre</th><th>Contacto</th><th class="text-end">Acciones</th></tr></thead>
                    <tbody>
                        <c:forEach var="prov" items="${listaProveedores}" varStatus="loop">
                            <tr>
                                <td>${loop.count}</td><td>${prov.id}</td><td><c:out value="${prov.nombre}"/></td><td><c:out value="${prov.contacto}"/></td>
                                <td class="text-end">
