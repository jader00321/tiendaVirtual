                ...
                <c:when test="${not empty listaCategorias}">
                    <c:forEach var="cat" items="${listaCategorias}">
                        <a href="${pageContext.request.contextPath}/catalogo?categoria=${cat.nombre}" class="tarjeta-categoria">
                            <c:choose>
                                <c:when test="${not empty cat.imagenUrl}">
                                    <img src="${pageContext.request.contextPath}/imagenes/${cat.imagenUrl}" alt="<c:out value="${cat.nombre}"/>">
                                </c:when>
                                <c:otherwise>
                                    <img src="${pageContext.request.contextPath}/imgenes/categoria_default.png" alt="Categoría por defecto">
                                </c:otherwise>
                            </c:choose>
